...
# Time-stamp: <2025-01-17 23:38:26 krylon>
#
...
** Clocktable
   ...
   #+CAPTION: Clock summary at [2025-01-17 Fr 23:38]
   | Headline                             | Time       |           |       |      |
   |--------------------------------------+------------+-----------+-------+------|
   | *Total time*                         | *2d 12:42* |           |       |      |
   |--------------------------------------+------------+-----------+-------+------|
   | *Snoopy [1/5]*                       | *2d 12:42* |           |       |      |
   | \_  /Components [1/3]/               |            | /2d 9:09/ |       |      |
   | \_    Data model [0/0]               |            |           |  0:37 |      |
   | \_    Database [1/3]                 |            |           |  8:55 |      |
   | \_      Relative paths               |            |           |       | 2:09 |
   | \_    Blacklist [0/0]                |            |           |  2:51 |      |
   | \_    Walker [0/0]                   |            |           | 10:48 |      |
   | \_    Extractor [0/0]                |            |           | 17:59 |      |
   | \_    UI [0/1]                       |            |           | 15:59 |      |
   | \_      Edit Blacklist from GUI      |            |           |       | 0:43 |
   | \_  /Bugs [0/1]/                     |            | /3:33/    |       |      |
   | \_    GUI hangs after extractor runs |            |           |  3:33 |      |
   #+END:
** Features [0/0]
   :PROPERTIES:
   :COOKIE_DATA: todo recursive
...
** Bugs [0/1]
   ...
   :VISIBILITY: children
   :END:
*** TODO GUI hangs after extractor runs
    :LOGBOOK:
